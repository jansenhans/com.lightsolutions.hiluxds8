...
let ST = {};
for (let k in CFG) {
  ST[k] = { dimUp: true, ctUp: true, fading: false, ctFading: false, lastTapEnd: 0, downTs: 0, tapPreceded: false, on: null, b: 50, ct: 3150, gen: 0, undoOn: null, singleTs: 0 };
}
...
Shelly.addEventHandler(function (ev) {
  ...
  if (e === "btn_down") {
    ...
    // Any hold following a recent tap is one compound gesture — the tap's
    // stray toggle is undone regardless of which sweep the gap selects.
    undoToggle(cfg, s, ts);
